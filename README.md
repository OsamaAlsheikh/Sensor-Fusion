...
What I Worked With:
      ...
      Built and used state-space models with motion and measurement models
      Modeled sensor noise and uncertainty
      Applied Rauch-Tung-Striebel (RTS) smoothing
      Solved tracking and positioning problems using simulated sensor data
      Evaluated and compared different filtering methods
